...
class Q98_Left_View_Of_Binary_Tree {
    ...
    ArrayList<Integer> leftView(Node root) {
        ...
        while (!queue.isEmpty()) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                // Add the first node in the current level to the result
                if (i == 0) {
    ...
    public static void main(String[] args) {
        ...
        for (int tc = 1; tc <= t; tc++) {
            ...
            Q98_Left_View_Of_Binary_Tree solution = new Q98_Left_View_Of_Binary_Tree();
            ArrayList<Integer> result = solution.leftView(root);

            System.out.println("Left View for tree " + tc + ": " + result);
        }
        scanner.close();
    }
}
